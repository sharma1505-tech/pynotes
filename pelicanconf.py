...
AUTHOR          = 'Sharma Ramalingam'  # use your name
SITENAME        = 'My Python Notes' # use title
GITHUB_USERNAME = 'Sharma1505-tech' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/sharma1505-tech "),
    ("LinkedIn", "https://www.linkedin.com/in/sharma-ramalingam"),
)
